...
class FarmaciaESPController extends Controller
{
    public function index($id)
    {
        ...
        if ($detalle && !empty($detalle->contenido)) {
            ...
            $viewData['inventario_anual'] = $preguntas['inventario_anual'] ?? null;

            // 6. Capacitación (Adaptador para Componente 4)
            ...
            // 7. Soporte (Adaptador para Componente 6)
