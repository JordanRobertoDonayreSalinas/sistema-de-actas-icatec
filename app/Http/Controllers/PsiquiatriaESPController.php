...
class PsiquiatriaESPController extends Controller
{
    public function index($id)
    {
        ...
        return view('usuario.monitoreo.modulos_especializados.psiquiatria', compact('monitoreo', 'data', 'equipos', 'detalle'));
    }
