...
@section('header-content')
    <div class="flex flex-col">
        <h1 class="text-xl font-bold text-slate-800 tracking-tight">Crear acta</h1>
...
@endsection
    ...
    <style>
        /* Animación para el Toast de imágenes */
        @keyframes fade-in { 
...
@section('content')
    <div class="py-10 bg-gradient-to-r from-blue-50 to-indigo-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="actaForm"
                  action="{{ route('admin.actas.store') }}"
                  method="POST"
...
"Parto","Planificacion Familiar","Puerperio","Teleatiendo","Triaje","VIH"];
