    ...
    <div class="min-h-screen bg-slate-50 py-10 px-4 sm:px-6 lg:px-8 font-sans text-slate-600">
        <div class="max-w-5xl mx-auto"> {{-- Ancho controlado y centrado --}}
            ...
            <div class="mb-10 text-center animate-slide-up">
                <span
                    class="inline-block py-1 px-3 rounded-full bg-indigo-100 text-indigo-700 text-[10px] font-black uppercase tracking-widest mb-3">Nuevo
                    Registro</span>
                <h1 class="text-3xl font-black text-slate-900 tracking-tight uppercase">Acta de Monitoreo</h1>
                <p class="text-slate-500 text-sm mt-2 max-w-2xl mx-auto">Complete la información del establecimiento y
                    registre al equipo responsable para iniciar el proceso.</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                ...
                                <input type="text" id="red" readonly
                                    class="w-full bg-transparent border-0 p-0 text-xs font-bold text-slate-700 focus:ring-0"
                                    value="---">
                            </div>
                            <div class="col-span-2 md:col-span-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                ...
                                <input type="text" id="microred" readonly
                                    class="w-full bg-transparent border-0 p-0 text-xs font-bold text-slate-700 focus:ring-0"
                                    value="---">
                            </div>
                        </div>
                        ...
                        @for ($i = 1; $i <= 2; $i++)
                            <div class="relative group">
                                ...
                                <label for="file_{{ $i }}" class="drop-zone" id="label_{{ $i }}">
                                    ...
                                    <span class="text-xs font-bold text-slate-400 uppercase tracking-wider">Subir Foto
                                        {{ $i }}</span>
                                </label>
