    ...
    <div class="py-10 bg-slate-50 min-h-screen" 
        ...
        images: {
            {{-- Forzamos a que si la cadena está vacía, Alpine reciba null --}}
        ...
        removeImage(key, inputId, actualId) {
            ...
            if(document.getElementById(actualId)) {
        ...
        <div class="py-12 bg-slate-50 min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <form id="form-cred-store" action="{{ route('usuario.monitoreo.cred.store', $acta->id) }}" method="POST" enctype="multipart/form-data" class="p-8 md:p-12 space-y-12">
                    @csrf
                    ...
                    <div class="space-y-8">
                        <div class="flex items-center gap-4">
                            <span class="h-12 w-12 rounded-2xl bg-indigo-600 text-white flex items-center justify-center text-lg font-black shadow-lg shadow-indigo-200 section-number"></span>
                            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wider">Métricas de Atenciones CRED</h4>
                        </div>

                        {{-- CONTENEDOR UNIFICADO (Fondo blanco, borde slate-200) --}}
                        <div class="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-6">
                            
                            <div class="flex items-center gap-2 mb-2">
                                <i data-lucide="bar-chart-3" class="w-4 h-4 text-indigo-500"></i>
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest italic">
                                    Resumen estadístico del mes actual
                                </p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="space-y-3">
                                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.1em] ml-2 flex items-center gap-2">
                                        <i data-lucide="users" class="w-3 h-3 text-indigo-400"></i>
                                        Nro de atenciones CRED del mes:
                                    </label>
                                    <input 
                                        type="number" 
                                ...
                                <div class="space-y-3">
                                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.1em] ml-2 flex items-center gap-2">
                                        <i data-lucide="download-cloud" class="w-3 h-3 text-indigo-400"></i>
                                        ¿Cuántas descargadas en HIS?
                                    </label>
                                    <input 
                                        type="number" 
                            ...
                            {{-- Pequeño aviso de validación visual --}}
                            <div class="mt-4 p-4 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                                <p class="text-[9px] text-slate-400 leading-relaxed">
                                    <span class="font-bold text-indigo-500">Nota:</span> Los datos ingresados aquí deben coincidir con lo reportado en el aplicativo oficial HIS-MINSA del presente periodo.
                                </p>
                            </div>
                            ...
                            <div class="relative h-56 rounded-[2rem] border-2 border-dashed border-slate-200 overflow-hidden bg-slate-50 flex items-center justify-center transition-all hover:bg-slate-100 group">
                                ...
                                <template x-if="images.img1">
                                    <div class="relative w-full h-full">
                                        ...
                                        <button type="button" 
                                                @click.stop="removeImage('img1', 'input_foto_1', 'foto_1_actual')" 
