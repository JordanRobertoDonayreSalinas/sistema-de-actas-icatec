        ...
        <div class="bg-white border border-slate-200 rounded-[3rem] shadow-xl overflow-hidden">
            <div class="bg-slate-900 p-10 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <span class="px-3 py-1 bg-indigo-500/20 border border-indigo-400/30 rounded-full text-indigo-300 text-[10px] font-black uppercase tracking-widest">Módulo CRED</span>
                    <h3 class="text-3xl font-black uppercase italic tracking-tight mt-2">Atención Integral del Niño</h3>
                </div>
            </div>

            <form action="{{ route('usuario.monitoreo.cred.store', $acta->id) }}" method="POST" enctype="multipart/form-data" class="p-8 md:p-12 space-y-12">
                @csrf
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6 bg-slate-50/50 p-8 rounded-[2.5rem] border border-slate-100">
                        ...
                        <div class="md:col-span-3 space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2 text-center block">Rol</label>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-2 cursor-pointer font-black text-xs text-slate-400">
                                        <input type="radio" name="contenido[capacitacion][recibio]" value="SI" {{ ($detalle->contenido['capacitacion']['recibio'] ?? '') == 'SI' ? 'checked' : '' }} class="text-indigo-600 radio-capacitacion"> SÍ
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer font-black text-xs text-slate-400">
                                        <input type="radio" name="contenido[capacitacion][recibio]" value="NO" {{ ($detalle->contenido['capacitacion']['recibio'] ?? '') == 'NO' ? 'checked' : '' }} class="text-indigo-600 radio-capacitacion"> NO
                                    </label>
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    ...
                    <div class="space-y-4">
                        <label class="text-[10px] font-black uppercase text-slate-400 ml-2 italic">Evidencia 02</label>
                        <div class="relative h-48 rounded-3xl border-2 border-dashed border-slate-200 overflow-hidden bg-slate-50 flex items-center justify-center">
                ...
                <div class="pt-10">
                    <button type="submit" class="w-full bg-indigo-600 text-white py-8 rounded-[2.5rem] font-black text-lg shadow-2xl hover:bg-indigo-700 transition-all flex items-center justify-center gap-6 group">
                        ...
                        FINALIZAR Y GUARDAR MÓDULO CRED
                    </button>
                </div>
            </form>
        </div>
