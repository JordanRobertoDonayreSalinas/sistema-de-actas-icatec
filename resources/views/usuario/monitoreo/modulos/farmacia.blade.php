        ...
        <div class="bg-white border border-slate-200 rounded-[3rem] shadow-xl overflow-hidden">
            ...
            <div class="bg-slate-900 p-10 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <span class="px-3 py-1 bg-indigo-500/20 border border-indigo-400/30 rounded-full text-indigo-300 text-[10px] font-black uppercase tracking-widest">Módulo de Farmacia</span>
                    <h3 class="text-3xl font-black uppercase italic tracking-tight mt-2">Gestión de Medicamentos e Insumos</h3>
                </div>
            </div>
                    ...
                    <div class="space-y-4 bg-slate-50/50 p-6 rounded-[2rem] border border-slate-100">
                        <div class="grid grid-cols-1 gap-3">
                            @foreach([
                                ...
                                'vencimiento_6meses' => '¿Cuenta con registro de productos próximos a vencer (menor a 6 meses)?',
