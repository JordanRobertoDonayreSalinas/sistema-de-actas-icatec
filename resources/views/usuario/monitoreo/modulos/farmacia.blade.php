...
<div class="py-10 bg-slate-50 min-h-screen" 
    ...
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="bg-white border border-slate-200 rounded-[3rem] shadow-xl overflow-hidden">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div class="flex items-center gap-5">
                                <div class="h-16 w-16 rounded-3xl bg-emerald-500 flex items-center justify-center shadow-2xl shadow-emerald-500/40 border border-emerald-400/30">
                                    <span class="text-3xl font-black italic text-emerald-950">15</span>
                                </div>
                                <div>
                                    <h3 class="text-4xl font-black uppercase tracking-tighter italic leading-none">Farmacia</h3>
                                </div>
                            </div>
            ...
            <form id="form-farmacia-store" action="{{ route('usuario.monitoreo.farmacia.store', $acta->id) }}" method="POST" enctype="multipart/form-data" class="p-8 md:p-12 space-y-12">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center gap-4 border-b border-slate-100 pb-4">
                        ...
                        <div>
                            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wider">Gestión de Stock</h4>
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-tight">Control de inventario y almacenamiento</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-6">
                        ...
                        <div class="mt-6 flex items-start gap-3 bg-indigo-50/50 p-4 rounded-2xl border border-indigo-100">
                            ...
                            <p class="text-[9px] text-indigo-700 leading-relaxed font-medium">
                                <span class="font-bold">Privacidad de datos:</span> Las imágenes subidas serán utilizadas exclusivamente para fines de auditoría y respaldo del presente monitoreo FARMACIA, cumpliendo con la normativa vigente de protección de datos personales.
                            </p>
                        </div>
