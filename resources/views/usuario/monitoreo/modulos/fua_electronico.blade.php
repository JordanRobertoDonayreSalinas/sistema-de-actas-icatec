        ...
        <form action="{{ route('usuario.monitoreo.fua-electronico.store', $acta->id) }}" 
            ...
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">¿Cuenta con sistema FUA del SIHCE?</label>
            ...
            {{-- SECCIÓN 4: CARACTERÍSTICAS DEL SOFTWARE --}}
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                <div class="flex items-center gap-4 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-3">
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="radio" name="contenido[modalidad_registro]" value="PUNTO_ATENCION" {{ ($detalle->contenido['modalidad_registro'] ?? '') == 'PUNTO_ATENCION' ? 'checked' : '' }} class="w-5 h-5">
                                <span class="text-sm font-bold text-slate-600">EN TIEMPO REAL</span>
                            </label>
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="radio" name="contenido[modalidad_registro]" value="DIGITACION" {{ ($detalle->contenido['modalidad_registro'] ?? '') == 'DIGITACION' ? 'checked' : '' }} class="w-5 h-5">
            ...
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    {{-- Backup --}}
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">¿Realiza Backup Local?</label>
                        <div class="flex gap-8 mt-2">
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="radio" name="contenido[realiza_backup]" value="SI" {{ ($detalle->contenido['realiza_backup'] ?? '') == 'SI' ? 'checked' : '' }} class="w-5 h-5">
                                <span class="text-sm font-bold">SÍ</span>
                            </label>
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="radio" name="contenido[realiza_backup]" value="NO" {{ ($detalle->contenido['realiza_backup'] ?? '') == 'NO' ? 'checked' : '' }} class="w-5 h-5">
                                <span class="text-sm font-bold">NO</span>
                            </label>
                        </div>
                    </div>
            ...
            {{-- SECCIÓN 4: RECURSOS CRÍTICOS (Checkboxes mejorados) --}}
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                <div class="flex items-center gap-4 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @php
                        $recursos = [
                            ...
                            'impresora_tickets' => 'Impresora de Tickets/Citas',
