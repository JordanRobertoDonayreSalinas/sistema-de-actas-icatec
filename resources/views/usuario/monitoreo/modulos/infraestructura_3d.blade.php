                ...
                return {
                    ...
                    exportImage() {
                        ...
                        async exportPdf() {
                            ...
                            window.open('{{ route('usuario.monitoreo.infraestructura-3d.pdf', $acta->id) }}', '_blank');
                        },
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button @click="exportImage()" title="Exportar croquis como imagen PNG"
                            @mouseenter="$el.style.backgroundColor='#047857'"
                            @mouseleave="$el.style.backgroundColor='#059669'"
                        ...
                        <button @click="exportPlano()" title="Exportar plano vectorial A1 para plotter (SVG)"
                            @mouseenter="$el.style.backgroundColor='#5b21b6'"
                            @mouseleave="$el.style.backgroundColor='#7c3aed'"
                            class="px-5 py-2 text-white rounded-xl text-[10px] font-black uppercase transition-all flex items-center gap-2 shadow-lg"
                                    ...
                                    <div class="grid grid-cols-2 gap-2 mb-4">
                                        <button @click="doorSubtype = 'interna'"
                                            ...
                                            <svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <rect x="6" y="13" width="7" height="8" rx="0" fill="rgba(220,220,220,0.95)" stroke="#111" stroke-width="0.8"/>
                                                <!-- Ventana: arco superior -->
                                                <path d="M6 16.5 A3.5 3.5 0 0 1 13 16.5" fill="rgba(220,220,220,0.95)" stroke="#111" stroke-width="0.8"/>
                                                <rect x="6" y="10" width="7" height="6.5" rx="0" fill="rgba(220,220,220,0.95)"/>
                                                <path d="M6 10 A3.5 3.5 0 0 1 13 10" fill="rgba(220,220,220,0.95)" stroke="#111" stroke-width="0.8"/>
                                                <!-- Divisor ventana -->
                                                <line x1="6.5" y1="16" x2="12.5" y2="16" stroke="#111" stroke-width="0.8"/>
                                                <!-- Contorno ventana completo -->
                                                <rect x="6" y="10" width="7" height="11" rx="0" fill="none" stroke="#111" stroke-width="0.8"/>
                                        ...
                                        <button @click="doorSubtype = 'externa'"
                                            ...
                                            <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <rect x="4.5" y="9" width="6" height="9" rx="0" fill="rgba(220,220,220,0.95)" stroke="#111" stroke-width="0.7"/>
                                                <path d="M4.5 12 A3 3 0 0 1 10.5 12" fill="rgba(200,200,200,0.95)"/>
                                                <path d="M4.5 9 A3 3 0 0 1 10.5 9" stroke="#111" stroke-width="0.7" fill="none"/>
                                                <line x1="5" y1="14" x2="10" y2="14" stroke="#111" stroke-width="0.7"/>
                                                <!-- Ventana derecha: arco -->
                                                <rect x="17" y="9" width="6" height="9" rx="0" fill="rgba(220,220,220,0.95)" stroke="#111" stroke-width="0.7"/>
