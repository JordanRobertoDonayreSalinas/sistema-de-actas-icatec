...
@section('content')
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-500 font-bold uppercase text-xs mt-1">
                        <i data-lucide="microscope" class="inline-block w-4 h-4 mr-1 text-teal-500"></i>
            ...
            <form action="{{ route('usuario.monitoreo.laboratorio.store', $acta->id) }}" method="POST"
                enctype="multipart/form-data" class="space-y-6" id="form-monitoreo-laboratorio">
                @csrf
                ...
                <div class="monitoreo-section bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">1</span>
                ...
                <div class="monitoreo-section bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">2</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-slate-100">
                        <div>
                            <label
                                class="block text-teal-600 text-[10px] font-black uppercase tracking-widest mb-2">¿Utiliza
                                SIHCE?</label>
                            <select name="contenido[cuenta_sihce]" id="cuenta_sihce"
                                onchange="toggleSihceAndDocs(this.value)"
                                class="w-full px-4 py-3 bg-teal-50 border-2 border-teal-100 rounded-xl font-bold text-sm uppercase outline-none text-teal-700 cursor-pointer hover:bg-teal-100 transition-colors">
                        ...
                        <div id="div_firmo_dj">
                            ...
                            <select name="contenido[firmo_dj]" id="firmo_dj"
                                class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-sm uppercase outline-none focus:border-teal-500">
                ...
                <div id="section_dni_detalle"
                    ...
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">3</span>
                        <h3 class="text-teal-900 font-black text-lg uppercase tracking-tight">DETALLE DE DNI Y FIRMA DIGITAL
                        </h3>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div id="card_electronico" onclick="selectDniType('ELECTRONICO')"
                                class="cursor-pointer border-2 rounded-2xl p-6 flex items-center gap-4 transition-all hover:shadow-md {{ ($contenido['tipo_dni'] ?? '') == 'ELECTRONICO' ? 'border-teal-600 bg-teal-50' : 'border-slate-200 bg-white' }}">
                                <div
                                    class="h-12 w-12 rounded-xl bg-teal-100 flex items-center justify-center text-teal-600">
                                    <i data-lucide="credit-card" class="w-6 h-6"></i>
                                </div>
                                <div>
                                    <h4 class="text-sm font-black text-slate-800 uppercase">DNI ELECTRÓNICO</h4>
                                    <span
                                        class="text-[10px] font-bold text-teal-500 bg-teal-100 px-2 py-0.5 rounded uppercase">Con
                                        Chip</span>
                                </div>
                            </div>
                            ...
                            <div id="card_azul" onclick="selectDniType('AZUL')"
                                class="cursor-pointer border-2 rounded-2xl p-6 flex items-center gap-4 transition-all hover:shadow-md {{ ($contenido['tipo_dni'] ?? '') == 'AZUL' ? 'border-teal-600 bg-teal-50' : 'border-slate-200 bg-white' }}">
                                <div
                    ...
                    <div id="bloque_opciones_dni"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div id="bloque_version_dnie"
                                ...
                                <label
                                    class="block text-teal-600 text-[10px] font-black uppercase tracking-widest mb-2">Versión
                                    del DNIe</label>
                                <select name="contenido[version_dnie]"
                                    class="w-full px-4 py-3 bg-white border-2 border-teal-100 rounded-xl font-bold text-sm uppercase outline-none focus:border-teal-500 text-teal-700">
                            ...
                            <div id="bloque_firma_digital"
                                class="{{ ($contenido['tipo_dni'] ?? '') == 'ELECTRONICO' ? '' : 'hidden' }}">
                                <label
                                    class="block text-teal-600 text-[10px] font-black uppercase tracking-widest mb-3">¿Firma
                                    Digitalmente en SIHCE?</label>
                                <div class="flex items-center gap-6">
                                    <label class="flex items-center gap-2 cursor-pointer group">
                                        <div class="relative flex items-center">
                                            <input type="radio" name="contenido[firma_digital_sihce]" value="SI"
                                                class="peer h-5 w-5 cursor-pointer appearance-none rounded-full border-2 border-slate-300 checked:border-teal-600 transition-all"
                                                {{ ($contenido['firma_digital_sihce'] ?? '') == 'SI' ? 'checked' : '' }}>
                                            <span
                                                class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-2.5 h-2.5 bg-teal-600 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity"></span>
                                        </div>
                                        <span
                                            class="text-sm font-bold text-slate-600 group-hover:text-teal-600 transition-colors">SÍ</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer group">
                                        <div class="relative flex items-center">
                            ...
                            <div class="md:col-span-2 mt-2">
                                ...
                                <textarea name="contenido[observaciones_dni]" rows="2"
                                    class="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl font-bold text-sm uppercase outline-none focus:border-teal-500 placeholder-slate-300"
                ...
                <div id="section_capacitacion"
                    ...
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">4</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="contenido[recibio_capacitacion]" id="recibio_capacitacion"
                                ...
                                class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-sm outline-none focus:border-teal-500 transition-all uppercase cursor-pointer">
                ...
                <div class="monitoreo-section bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">5</span>
                ...
                <x-tipo-conectividad :num="6" :contenido="$contenido" color="teal" />

                {{-- 7.- SOPORTE Y COMUNICACIÓN (Oculto si SIHCE es NO) --}}
                <div id="section_soporte"
                    ...
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">7</span>
                ...
                {{-- 8.- PROCESOS Y CALIDAD (ESPECÍFICO DE LABORATORIO) --}}
                <div class="monitoreo-section bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span
                            class="section-number bg-teal-600 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">8</span>
                        <h3 class="text-teal-900 font-black text-lg uppercase tracking-tight">PROCESOS Y CALIDAD</h3>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label
                                class="block text-slate-500 text-[10px] font-black uppercase tracking-widest mb-2">¿Cuenta
                                con Manual de Procedimientos?</label>
                            <select name="contenido[cuenta_manual_procedimientos]"
                                class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-sm outline-none uppercase cursor-pointer focus:border-teal-500">
                                <option value="SI" {{ ($contenido['cuenta_manual_procedimientos'] ?? '') == 'SI' ? 'selected' : '' }}>SI</option>
                                <option value="NO" {{ ($contenido['cuenta_manual_procedimientos'] ?? '') == 'NO' ? 'selected' : '' }}>NO</option>
                            </select>
                        </div>
                        <div>
                            <label
                                class="block text-slate-500 text-[10px] font-black uppercase tracking-widest mb-2">¿Realiza
                                Control Interno?</label>
                            <select name="contenido[realiza_control_interno]"
                                class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-sm outline-none uppercase cursor-pointer focus:border-teal-500">
                                <option value="SI" {{ ($contenido['realiza_control_interno'] ?? '') == 'SI' ? 'selected' : '' }}>SI</option>
                                <option value="NO" {{ ($contenido['realiza_control_interno'] ?? '') == 'NO' ? 'selected' : '' }}>NO</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        <div>
                            <div class="flex items-center gap-3 mb-6">
                                <span
                                    class="bg-teal-500 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">9</span>
                                <h3 class="text-white font-black text-lg uppercase tracking-tight">COMENTARIOS</h3>
                            </div>
                            <textarea name="contenido[comentarios]" rows="6"
                                class="w-full bg-white/10 border-2 border-white/20 rounded-2xl p-4 text-white font-bold outline-none focus:border-teal-500 transition-all uppercase placeholder-white/30">{{ $contenido['comentarios'] ?? '' }}</textarea>
                        </div>
                        <div>
                            <div class="flex items-center gap-3 mb-6">
                                <span
                                    class="bg-teal-500 text-white w-8 h-8 flex items-center justify-center rounded-full font-black text-sm">10</span>
                            ...
                            <div class="relative group">
                                ...
                                <div id="dropzone"
                                    ...
                                    <span id="file-name-display"
                                        class="text-[10px] font-bold uppercase tracking-widest text-slate-300 text-center">{{ $fotoEvidencia ? 'CLICK PARA CAMBIAR' : 'SUBIR FOTO' }}</span>
                                    <img id="img-preview" src="#"
                                        class="hidden mt-4 h-48 w-auto object-contain rounded-lg border-2 border-teal-500 shadow-xl">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" id="btn-submit-action"
                        ...
                        <div class="flex items-center gap-8 pointer-events-none">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-[10px] text-teal-200 font-bold uppercase mt-3 tracking-widest">Sincronizar
                                    Módulo Laboratorio</p>
                            </div>
                        </div>
                        <div
        ...
        // --- ACTUALIZACIÓN DINÁMICA DE NUMERACIÓN ---
            ...
            function checkNationality(tipoDoc) {
                ...
                if (tipoDoc === 'DNI') {
                    ...
                    document.getElementById('card_electronico').classList.remove('border-teal-600', 'bg-teal-50');
                    document.getElementById('card_electronico').classList.add('border-slate-200', 'bg-white');
                    document.getElementById('card_azul').classList.remove('border-teal-600', 'bg-teal-50');
