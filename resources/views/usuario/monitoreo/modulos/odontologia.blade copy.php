...
@section('title', 'Módulo 53: Odontologia')
...
<div class="py-12 bg-[#f8fafc] min-h-screen" x-data="triajeForm()">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form @submit.prevent="guardarTodo" class="space-y-8">
            ...
            {{-- 3. [NUEVO] SECCIÓN INICIO LABORES --}}
            <div class="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-xl shadow-slate-200/50 relative overflow-hidden">
                <div class="absolute top-0 right-0 w-24 h-24 bg-indigo-50 rounded-full -mr-12 -mt-12 opacity-60 pointer-events-none"></div>
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-slate-900 uppercase tracking-tight">Sección Inicio Labores</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                                ...
                                <div class="space-y-3">
                                    <label class="flex items-center gap-3 cursor-pointer group">
                                        <input type="radio" value="FUA_ELECTRONICA" x-model="form.inicio_labores.fua" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-slate-300">
                                        <span class="text-xs font-bold text-slate-600 group-hover:text-indigo-600 transition-colors uppercase">FUA Electrónica</span>
                                    </label>
                                    <label class="flex items-center gap-3 cursor-pointer group">
                                        <input type="radio" value="FUA_MANUAL" x-model="form.inicio_labores.fua" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-slate-300">
                            ...
                            <div class="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <label class="flex items-center gap-3 cursor-pointer group">
                                        <input type="radio" value="REFCON" x-model="form.inicio_labores.referencia" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-slate-300">
