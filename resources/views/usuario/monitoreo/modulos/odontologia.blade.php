...
<div class="py-12 bg-[#f8fafc] min-h-screen" x-data="odontologiaForm()">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form @submit.prevent="guardarTodo" class="space-y-8">
            ...
            {{-- 1. SECCIÓN INICIO LABORES (ESPECÍFICO DE ODONTOLOGÍA) --}}
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <template x-for="(item, index) in form.inventario" :key="item.id">
                                <tr class="group hover:bg-slate-50/50 transition-colors">
                                    ...
                                    {{-- NUEVO: SELECTOR COMPUESTO (NS/CB + INPUT) --}}
                                    <td class="py-3 px-2 align-middle">
...
<script>
    function odontologiaForm() {
        ...
        // --- 2. Inicio Labores (ESPECÍFICO DE ODONTOLOGÍA - MANTENIDO) ---
        ...
        if (dbInventario && dbInventario.length > 0) {
            initInventario = dbInventario.map(item => {
                ...
                return {
                    ...
                    estado: item.estado,
                    tipo_codigo: tipoDetectado, // Nuevo campo visual
                    codigo: codigoLimpio,       // Nuevo campo visual
