                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div class="flex items-center gap-5">
                            <div class="h-16 w-16 rounded-3xl bg-emerald-500 flex items-center justify-center shadow-2xl shadow-emerald-500/40 border border-emerald-400/30">
                                <span class="text-3xl font-black italic text-emerald-950">11</span>
                            </div>
                            <div>
                                <h3 class="text-4xl font-black uppercase tracking-tighter italic leading-none">Planificación Familiar</h3>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 bg-white/5 backdrop-blur-md px-5 py-3 rounded-3xl border border-white/10 shadow-xl">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="date" name="fecha_monitoreo" id="fecha_monitoreo" form="form-planificacion-familiar-store"
