        ...
        <form action="{{ route('usuario.monitoreo.laboratorio.store', $acta->id) }}" 
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                    ...
                    <h3 class="text-teal-900 font-black text-lg uppercase tracking-tight">DETALLES DEL AMBIENTE</h3>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    {{-- NRO DE AMBIENTES --}}
                    <div>
                        <label class="block text-slate-500 text-[10px] font-black uppercase tracking-widest mb-2">Nro. de Ambientes / Labs</label>
                        <input type="number" 
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="EJ: HEMATOLOGÍA / TOMA DE MUESTRAS">
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div id="bloque_version_dnie" class="{{ ($detalle->contenido['tipo_dni'] ?? '') == 'ELECTRONICO' ? '' : 'hidden' }}">
                            ...
                            <select name="contenido[version_dnie]" class="w-full px-4 py-3 bg-white border-2 border-teal-100 rounded-xl font-bold text-sm uppercase outline-none focus:border-teal-500 text-teal-700">
                                ...
                                <option value="1.0" {{ ($detalle->contenido['version_dnie'] ?? '') == '1.0' ? 'selected' : '' }}>VERSIÓN 1.0 (2013)</option>
                                <option value="2.0" {{ ($detalle->contenido['version_dnie'] ?? '') == '2.0' ? 'selected' : '' }}>VERSIÓN 2.0 (2020)</option>
                                <option value="3.0" {{ ($detalle->contenido['version_dnie'] ?? '') == '3.0' ? 'selected' : '' }}>VERSIÓN 3.0 (2024)</option>
                            </select>
                        </div>
