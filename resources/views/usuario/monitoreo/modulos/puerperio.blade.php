        ...
        <div class="mb-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-1">
                    <span class="px-3 py-1 bg-rose-600 text-white text-[10px] font-black rounded-lg uppercase tracking-widest">Módulo Asistencial</span>
        ...
        <form action="{{ route('usuario.monitoreo.puerperio.store', $acta->id) }}" 
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    {{-- DENOMINACIÓN --}}
                    <div>
                        <label class="block text-slate-500 text-[10px] font-black uppercase tracking-widest mb-2">Denominación de Consultorio</label>
                        <input type="text" 
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-lg border border-slate-100">
                <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                    ...
                    <h3 class="text-rose-900 font-black text-lg uppercase tracking-tight">DETALLES DE CAPACITACION</h3>
                </div>
                ...
                <button type="submit" id="btn-submit-action" 
                    ...
                    <div class="flex items-center gap-8 pointer-events-none">
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-[10px] text-rose-200 font-bold uppercase mt-3 tracking-widest">Sincronizar Módulo 13 con el Maestro</p>
                        </div>
                    </div>
