...
<div class="py-12 bg-slate-50 min-h-screen">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('usuario.monitoreo.urgencias.store', $acta->id) }}" 
            ...
            {{-- SECCIÓN 0: TURNO --}}
            <div class="bg-red-600 rounded-[3rem] p-10 shadow-xl shadow-red-200/50 border border-red-500 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-red-100 text-[10px] font-bold uppercase tracking-widest">Horario de evaluación</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Prioridad de Triaje Predominante</label>
                        <select name="contenido[triaje_prioridad]" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-sm outline-none focus:border-red-500 transition-all uppercase shadow-sm">
                            <option value="PRIORIDAD III" {{ ($detalle->contenido['triaje_prioridad'] ?? '') == 'PRIORIDAD III' ? 'selected' : '' }}>PRIORIDAD III (URGENCIA MENOR)</option>
                            <option value="PRIORIDAD IV" {{ ($detalle->contenido['triaje_prioridad'] ?? '') == 'PRIORIDAD IV' ? 'selected' : '' }}>PRIORIDAD IV (PATOLOGÍA AGUDA COMÚN)</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Tiempo Promedio de Espera</label>
                        <select name="contenido[tiempo_espera]" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-sm outline-none focus:border-red-500 transition-all uppercase shadow-sm">
                ...
                <div class="mt-8">
                    ...
                    <select name="contenido[acceso_sistema]" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-red-500 font-bold text-sm outline-none transition-all cursor-pointer shadow-sm uppercase">
            ...
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10 border-b border-slate-100 pb-10">
                    <div>
                        ...
                        <select name="contenido[recibio_capacitacion]" id="recibio_capacitacion" onchange="toggleEntidadCapacitadora(this.value)" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-sm outline-none focus:border-red-500 transition-all uppercase">
                    ...
                    <div id="wrapper_entidad_capacitadora" class="transition-all duration-300">
                        ...
                        <select name="contenido[inst_que_lo_capacito]" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-sm outline-none focus:border-red-500 transition-all uppercase">
            ...
            <div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div>
                        ...
                        <select name="contenido[inst_a_quien_comunica]" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-sm outline-none uppercase focus:border-red-500">
                    ...
                    <div>
                        ...
                        <select name="contenido[medio_que_utiliza]" class="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-sm outline-none uppercase focus:border-red-500">
            ...
            <div class="bg-slate-900 rounded-[3.5rem] p-12 shadow-2xl text-white relative overflow-hidden">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                    <div>
                        ...
                        <textarea name="contenido[comentarios]" rows="5" class="w-full bg-white/5 border-2 border-white/10 rounded-3xl p-6 text-white font-bold outline-none focus:border-red-500 transition-all uppercase placeholder-white/20 shadow-inner">{{ $detalle->contenido['comentarios'] ?? '' }}</textarea>
                    </div>
                ...
                <button type="submit" id="btn-submit-action" class="w-full group bg-red-600 text-white p-10 rounded-[3rem] font-black shadow-2xl flex items-center justify-between hover:bg-red-700 transition-all duration-500 active:scale-[0.98]">
                    <div class="flex items-center gap-8 pointer-events-none">
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-[10px] text-red-100 font-bold uppercase mt-3 tracking-widest">Sincronizar Módulo 18 en el Sistema</p>
                        </div>
                    </div>
