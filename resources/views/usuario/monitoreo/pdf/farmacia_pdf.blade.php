...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* SECCIÓN FOTOS: Lógica dinámica idéntica a CRED */
        ...
        /* BLOQUE DE FIRMA ESTILIZADO (RECUADRO) */
        .signature-card { 
...
<body>
    ...
    <table class="table-data">
        <thead>
            <tr>
                <th width="85%">Pregunta de Control</th>
                ...
                <td class="signature-card" style="width: 60%; text-align: center;">
                    ...
                    <div style="font-size: 10px; color: #334155; margin-top: 5px;">
                        ...
                        <span style="font-style: italic; color: #64748b;">
                            {{ $detalle->personal_roles ?? 'Responsable de Farmacia' }}
                        </span>
                    </div>
                </td>
                <td style="width: 20%; border: none;"></td>
