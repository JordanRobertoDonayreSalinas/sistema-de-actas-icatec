...
<body>
    ...
    <table>
        <tr>
            ...
            <td class="uppercase">{{ $detalle->contenido['numero_consultorio'] ?? '---' }}</td>
        </tr>
        <tr>
            <td class="bg-label">Denominación del Consultorio</td>
    ...
    <div class="section-title">6. Utilización de Reportes del Sistema</div>
    <table>
        <tr>
    ...
    <div class="firma-section">
        ...
        <div class="firma-container">
            <div class="firma-box">
                ...
                <div class="firma-label">LIC. ENFERMERIA</div>
